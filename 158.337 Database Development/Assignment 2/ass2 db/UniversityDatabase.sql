-- script to create university database for the 2016 project
...
'FL', '32811', '7155559876', 'SR', TO_DATE('07/14/1989', 'MM/DD/YYYY'), 8891, 1, TO_YMINTERVAL('3-2'));
...
'FL', '32320', '7155553907', 'JR', TO_DATE('10/10/1986', 'MM/DD/YYYY'), 1613, 1, TO_YMINTERVAL('3-0'));

INSERT INTO student VALUES
('SM100', 'Smith', 'Mike', NULL, '428 Markson Ave', 'Eastpoint', 
'FL', '32328', '7155556902', 'SO', TO_DATE('09/24/1990', 'MM/DD/YYYY'), 1841, 2, TO_YMINTERVAL('2-2'));

INSERT INTO student VALUES
('JO101', 'Johnson', 'Lisa', 'M', '764 Johnson Place', 'Leesburg', 
'FL', '34751', '7155558899', 'SO', TO_DATE('11/20/1990', 'MM/DD/YYYY'), 4420, 4, TO_YMINTERVAL('1-11'));

INSERT INTO student VALUES
('NG100', 'Nguyen', 'Ni', 'M', '688 4th Street', 'Orlando', 
'FL', '31458', '7155554944', 'FR', TO_DATE('12/4/1990', 'MM/DD/YYYY'), 9188, 3, TO_YMINTERVAL('0-4'));

--- inserting records into TERM
INSERT INTO term (term_id, term_desc, status, start_date) VALUES 
(1, 'Fall 2011', 'CLOSED', '29-AUG-11');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(2, 'Spring 2012', 'CLOSED', '09-JAN-12');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(3, 'Summer 2012', 'CLOSED', '15-MAY-12');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(4, 'Fall 2012', 'CLOSED', '28-AUG-12');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(5, 'Spring 2013', 'CLOSED', '08-JAN-13');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(6, 'Summer 2014', 'OPEN', '07-MAY-14');

INSERT INTO term (term_id, term_desc, status, start_date) VALUES
(7, 'Spring 2014', 'CLOSED', '09-JAN-14');
...
--modified last record in March, 2012, removed Monday from the days being taught
...
INSERT INTO course_section VALUES
(13, 'MIS 441', 6, 1, 3, 'TWRF', TO_DATE('09:00 AM', 'HH:MI AM'), TO_DSINTERVAL('0 00:01:30.00'), 5, 35);
